...
import 'package:flutter_application_1/pages/connexion.dart';
 ...
 class InscriptionMedecin extends StatelessWidget {
           ...
           Animations(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                labelText: 'Autorisation de pratique privee ',
                border: OutlineInputBorder(),
                suffixIcon: IconButton(
                  icon: Icon(
                    Icons.download,
        ...
        const  SizedBox(height: 10),
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                labelText: 'hopital affilier (facultatif)',
                border: OutlineInputBorder(),
                suffixIcon: IconButton(
                  icon: Icon(
                    Icons.add,
